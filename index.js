...
const students = [
    { ID: 1, name: 'Sanket', age: 24, grade: 'A', degree: 'BSC CS', email: 'sanket@gmail.com' },
    { ID: 2, name: 'Swara', age: 18, grade: 'B', degree: 'BCA', email: 'swaraa@gmail.com' },
    { ID: 3, name: 'Durgesh', age: 27, grade: 'C', degree: 'Btech', email: 'durgesh@gmail.com' }
  ];
